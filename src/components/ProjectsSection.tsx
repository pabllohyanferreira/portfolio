            ...
            <div key={project.id} className="project-card">
              ...
              <div className="project-media">
                <iframe 
                  ...
                  src={`https://www.youtube.com/embed/${project.youtubeId}?autoplay=1&loop=1&playlist=${project.youtubeId}&mute=1&controls=0&showinfo=0&rel=0&modestbranding=1&vq=hd1080&quality=hd1080&hd=1`}
                  title={project.title}
                  frameBorder="0"
